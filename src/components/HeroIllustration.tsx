  ...
  return (
    <div className="relative w-full max-w-lg mx-auto">
      ...
      >
        ...
        <g>
          {/* Header */}
          <text x="140" y="72" fontSize="10" fontWeight="600" fill="hsl(var(--foreground))">
            Dashboard
          </text>
          
          {/* Balance card */}
          <rect x="136" y="80" width="128" height="50" rx="8" fill="url(#primaryGradient)" />
          <text x="146" y="98" fontSize="8" fill="white" opacity="0.8">
            Saldo atual
          </text>
          <text x="146" y="118" fontSize="14" fontWeight="700" fill="white">
            R$ 2.450,00
          </text>
          ...
          <g transform="translate(170, 170)">
            ...
            <text y="4" fontSize="8" textAnchor="middle" fill="hsl(var(--foreground))" fontWeight="600">
              Gastos
            </text>
          </g>
          ...
          <g transform="translate(136, 215)">
            ...
            <rect y="10" width="85" height="8" rx="4" fill="url(#successGradient)">
              <animate
                ...
                dur="1.5s"
                fill="freeze"
                begin={mounted ? "0s" : "indefinite"}
              />
            </rect>
            <text x="130" y="16" fontSize="6" fill="hsl(var(--muted-foreground))" textAnchor="end">
              66%
            </text>
          </g>
